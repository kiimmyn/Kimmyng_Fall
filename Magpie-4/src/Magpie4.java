public class Magpie4 {
	...
	public String getResponse(String statement) {
		...
		if (statement.length() ==0){
			...
			} else if (findKeyword(statement, "Mr. Millstein") >= 0){
			response = "He seems like a good teacher";
		} else if (findKeyword(stataement, "Mrs.") >= 0)
	...
	private String transformIWantToStatement(String statement) {
		...
		return "How would you feel if you had " + restOfStatement + "?";
	}
	...
	private String transformIYouStatement(String statement) {
		...
		String restOfStatement = statement.substring(psnOfI + 1, psnOfYou)
				.trim();
		return "How come you" + restOfStatement + " me?";
	}
	...
	private String getRandomResponse() {
		final int RESPONSE_NUMBER = 6;
		double r = Math.random();
		int whichResponse = (int) (r * RESPONSE_NUMBER);
		String response = "";
		
		if (whichResponse == 0) {
			response = "That is amazing, what else?";
